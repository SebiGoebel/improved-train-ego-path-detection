...
#plt.plot(x_values, single_frame_based_parts[sequence_num]       , marker='.', color='darkgray', label=f'single-frame-based')
#plt.plot(x_values, single_frame_based_parts_og[sequence_num]    , marker='.', color='darkgray', label=f'single-frame-based (ogA)')
