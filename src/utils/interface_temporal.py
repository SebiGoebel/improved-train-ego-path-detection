...
from ..nn.lstm_model import RegressionNetCNN_LSTM_FC, RegressionNetCNN_FC_LSTM, RegressionNetCNN_LSTM, RegressionNetCNN_FC_FCOUT, RegressionNetCNN_LSTM_V2, RegressionNetCNN_LSTM_HEAD_V2, RegressionNetCNN_FLAT_FC, RegressionNetCNN_FC_FCOUT_V2
...
class DetectorTemporal:
    ...
    def init_model_pytorch(self):
        if self.config["method"] == "classification":
            ...
            model = RegressionNetCNN_FC_FCOUT_V2( # RegressionNetCNN_LSTM_FC, RegressionNetCNN_FC_LSTM, RegressionNetCNN_LSTM, RegressionNetCNN_FC_FCOUT,
