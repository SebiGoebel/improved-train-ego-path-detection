...
e.g.: python calculateIoU_singleFrame_temporalDataset.py kind-donkey-84 --device cuda:0
...
from src.utils.common import set_seeds, set_worker_seeds, simple_logger, split_dataset, split_dataset_by_sequence
